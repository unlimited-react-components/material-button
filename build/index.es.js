...
import { hexColorToRGB, asureColor, colourNameToHex, mergeProps, darkerColor } from '@unlimited-react-components/kernel';
...
var MaterialButton = function (props) {
    ...
    var handleInserStyle = function (variant, disabled, color, textColor, class_name, text) {
        ...
        var id = DynamiCSS.insertStyleSheet(styleSheet);
        setIdStyles(id);
        if (id !== "") {
